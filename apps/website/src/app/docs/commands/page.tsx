		...
		<>
			<div className="flex flex-col space-y-12 pt-4">
				<Divider>
					...
					<Paragraph>
						Read about some of the important commands in Ticketer as a moderator or user of the bot!
					</Paragraph>
				</Divider>
				<Divider>
					...
					<SectionDivider header="Configuring Thread Tickets">
						<Paragraph>
							...
							<i>/configuration-ticket-threads global-settings</i>. There is currently only one configuration to set:
							the amount of active tickets a user may have globally at once.
						</Paragraph>
						...
						<Paragraph>
							You then need to choose the &quot;ticket managers&quot; who are responsible for the category, as well as
							the text channel where these tickets go. These settings, including more, can be found using the subcommand
							below:
						</Paragraph>
				...
				<Divider>
					...
					<Paragraph>
						In addition to thread tickets, Ticketer provides a way to send a message everytime a new thread in a
						specified forum is created. The subcommand to create a new user forum configuration goes as follows:
					</Paragraph>
				...
				<Divider>
					...
					<Paragraph>
						Similar to user forums, Ticketer can create a thread under a new message sent in a specified text channel.
						The subcommand below can be used to create a new configuration for automatic threads.
					</Paragraph>
